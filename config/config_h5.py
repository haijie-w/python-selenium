...
# 1.基本的配置元素
basic_config = {
	'url': 'https://oola-m-tt.oola.cn/h5/#/recycle?channel=136_1',
	'phone': [18011723755, 18011723722, 18011722753, 18028567802, 13424083222],
	'code':  '326618'
}

# 2. 元素定位地址
element_config = {
	"loadAD": "//*[@id='app']/div[2]/div[1]/div[1]/div[1]/div[2]/div/img",
	'personal': "//*[@id='app']/div[2]/div[1]/div[2]/a[3]",
	'login_page': "//*[@id='app']/div[2]/div[1]/div[1]/div[2]",
