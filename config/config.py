...
local_config = {
    ...
    '个人页面': {
        ...
        '数字1': ['xpath', "//div[@class='popup number-keyboard']/div[1]/div[1]"],
        '数字2': ['xpath', "//div[@class='popup number-keyboard']/div[1]/div[2]"],
        '数字3': ['xpath', "//div[@class='popup number-keyboard']/div[1]/div[3]"],
        '数字4': ['xpath', "//div[@class='popup number-keyboard']/div[2]/div[1]"],
        '数字5': ['xpath', "//div[@class='popup number-keyboard']/div[2]/div[2]"],
        '数字6': ['xpath', "//div[@class='popup number-keyboard']/div[2]/div[3]"],
        '数字7': ['xpath', "//div[@class='popup number-keyboard']/div[3]/div[1]"],
        '数字8': ['xpath', "//div[@class='popup number-keyboard']/div[3]/div[2]"],
        '数字9': ['xpath', "//div[@class='popup number-keyboard']/div[3]/div[3]"],
